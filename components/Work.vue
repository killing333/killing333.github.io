<template lang="html">
    <div id="component-work" class="component">
        <div class="row">
            <div class="col-sm-2">
                <img v-if="work.icon" class="work-icon work-icon-rounded" v-bind:src="work.icon" alt="">
            </div>
            <div class="col-sm-10">
                <h2 class="work-title">{{ work.title }}
                    <a v-for="(platform, index) in work.platforms" v-bind:href="work.link !== null && typeof work.link === 'object' ? work.link[platform] : '#'" target="_blank" class="platform-icon hidden-print">
                    <svg v-if="platform === 'ios'" xmlns="http://www.w3.org/2000/svg" width="170px" viewBox="0 0 170 170" version="1.1" height="170px">
                    ...
                    <svg v-if="platform === 'android'" xmlns="http://www.w3.org/2000/svg" fill="#000000" height="48" viewBox="0 0 24 24" width="48">
                    ...
                    <svg v-if="platform === 'web'" xmlns="http://www.w3.org/2000/svg" fill="#000000" height="48" viewBox="0 0 24 24" width="48">
                    ...
                    <svg v-if="platform === 'win'" xmlns="http://www.w3.org/2000/svg" version="1.1" height="88" width="88" viewBox="0 0 88 88">
...
module.exports = {
    computed: {
        ...
        work_tags: function() {
            ...
            if (_.isArray(this.work.tags)) {
                for (var i = 0; i < this.work.tags.length; i++) {
                    let tag = this.tags[this.work.tags[i]];
